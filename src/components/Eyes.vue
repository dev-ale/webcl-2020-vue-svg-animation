    ...
    <div>
        ...
        <div>
            <svg width=50% height=50% viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <circle class="moving-eyes" cx="139.5" cy="57.5" r="4.5" fill="black"/>
                <circle class="moving-eyes" cx="66.5" cy="57.5" r="4.5" fill="black"/>
            </svg>
...
<style>
    .moving-eyes{
        ...
        top: 1%;
        left:5%;
        animation: lookingAround 2s infinite;
    }
